---
title: "C++ 中的 stack"
commentId: "post:stack-in-cpp"
published: "2026-02-19 10:45:00 +08:00"
description: "本文从本质需求出发解释栈（LIFO）为何存在，串联函数调用、递归、撤销与括号匹配等典型场景，并结合 C++ STL 的 std::stack 用法、异常安全设计与底层容器选择，最后配合多道题目示例完成从概念到实战的闭环。"
category: Note
tags:
  - C++
draft: false
